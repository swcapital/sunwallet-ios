...
extension Color {
    ...
    static let lightBlueColor: Color = Color(red: 45.0/255.0, green: 40.0/255.0, blue: 198.0/255.0)
    static let darkBlueColor: Color = Color(red: 20.0/255.0, green: 18.0/255.0, blue: 89.0/255.0)
    static let lightGrayColor: Color = Color(red: 18/255, green: 31/255, blue: 71/255)
